...
<title>注册页面</title>
<script type="text/javascript" src = "/IStore/js/jquery-3.2.1.min.js"></script>
<link href="<%=request.getContextPath() %>/css/common.css" rel="stylesheet" type="text/css"/>
<link href="<%=request.getContextPath() %>/css/register.css" rel="stylesheet" type="text/css"/>
<script type="text/javascript" src="/IStore/js/register.js"></script>
</head>
			...
			<div class="wrap">
				<div class="main clearfix">
					...
					<form id="registerForm"
						action="<%=request.getContextPath() %>/user/regist"
							...
							<tbody>
								...
								<tr>
									...
									<td><input type="password" id="password" name="password"
										class="text" maxlength="20" autocomplete="off" onblur="checkPwd1()" /> <span id="error_pwd"></span></td>
								</tr>
								<tr>
									<th><span class="requiredField">*</span>确认密码:</th>
									<td><input id="repassword" type="password"
										name="repassword" class="text" maxlength="20"
										autocomplete="off" onblur="checkPwd2()" /><span id = "error2_pwd"></span>
									</td>
								</tr>
								<tr>
									<th>姓名:</th>
								...
								<tr>
									<th>生日:</th>
									<td>
										<input type="date" id="birth" name="birth" class="text" onblur="checkBirth()" />
										<span id = "error_birth"></span>
									</td>
								</tr>
								<tr>
									<th>电话:</th>
									<td><input type="text" id="telephone" name="telephone" class="text" onchange="checkTell()" />
										<span id="error_tell"></span>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><span class="fieldSet"> 
										<input type="text"
											...
											maxlength="4" autocomplete="off" onchange="verdictImg()">
										<img id="checkImg" class="captchaImage"
											src="${pageContext.request.contextPath}/user/checkImg"
											onclick="changeImgCode()" title="点击更换验证码">
									</span>
									<span id = "error_checkcode"></span>	
									</td>
								</tr>
								<tr>
									<th>&nbsp;</th>
						...
						<div class="login">
							...
							<dl>
								...
								<dd>
									立即登录即可体验在线购物！ <a
										href="${pageContext.request.contextPath}/user/loginUI">立即登录</a>
								</dd>
							</dl>
						</div>
					</form>
